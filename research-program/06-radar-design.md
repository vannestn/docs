...
| **C. Compute, environment & supply chain** | 1, 3 | IEA, SemiAnalysis, datacenter/power/water reporting, BIS export-control actions, chip-supply news (TSMC/HBM), Epoch compute tracking |
...
| **E. Social impact: labor, cognition, bias** | 5, 6, 7 | NBER/SSRN working papers, Anthropic Economic Index updates, FAccT/CHI proceedings, cognition-and-AI studies, enforcement news (NYC LL144, Colorado, EEOC) |
