...
| 4 | [SuggestionFix-Bench](04-code-review-catch-vs-noise.md) | SuggestionFix-Bench: Grading AI Code-Review Corrections Against Humans' Own Accepted PR Fixes | ICSE/FSE/ISSTA or ML4Code workshop; arXiv + released dataset | Suggestion blocks are rare (~8% are defect fixes) → the gold set may fall under 500 items (its pre-registered kill); broad framing was scooped, only the exact-fix-oracle wedge survives. |
