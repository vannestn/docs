...
- **Professional deskilling is now empirically documented in medicine**: endoscopists' adenoma
  ...
  [The Lancet Gastroenterology & Hepatology 2025](https://www.thelancet.com/journals/langas/article/PIIS2468-1253%2825%2900133-5/abstract)
  ...
  [deskilling commentary](https://www.thelancet.com/journals/langas/article/PIIS2468-1253%2825%2900164-5/abstract).
  **Independently corroborated by a controlled experiment in a different modality/country/design**: Dratsch et al.,
  [*Radiology* 2023](https://pubs.rsna.org/doi/10.1148/radiol.222176) (DOI 10.1148/radiol.222176; PMID 37129490; German group) — 27 radiologists read mammograms
  with a *purported* AI's BI-RADS suggestions; when the AI suggested the *wrong* category, correct-scoring
  collapsed from ~80% to ~20% (inexperienced) and 82%→45.5% (very experienced) — *automation bias* degrades even
  expert human judgment. Together the two are independent primaries (in-vivo natural experiment vs. lab experiment)
  reaching the same conclusion: routine AI reliance erodes unaided human performance.
...
- **Cognitive offloading correlates**: Gerlich's survey+interview study (n=666) found frequent
  ...
  **A stronger, independent, *randomized* design points the same way**: Fan et al.,
  ["Beware of Metacognitive Laziness"](https://bera-journals.onlinelibrary.wiley.com/doi/abs/10.1111/bjet.13544)
  (*Brit. J. Educ. Tech.* 2025; also [arXiv:2412.09315](https://arxiv.org/abs/2412.09315); RCT, n=117 randomized to ChatGPT
  / human-expert / analytics-tool / no-tool on a writing task) — the ChatGPT group engaged in *significantly fewer
  metacognitive self-regulation activities* and their knowledge gain/transfer did **not** exceed controls despite higher
  essay scores; authors coin "metacognitive laziness." An experiment (not a survey) so it partly answers the causality
  caveat for *short-horizon offloading of effort*, though it is still not a *longitudinal skill-decay* trial — that gap stands.
- **Neural/behavioral traces**: MIT Media Lab's "[Your Brain on ChatGPT](https://arxiv.org/abs/2506.08872)"
  (what it did: n=54 in Sessions 1–3 = 18/group between-subjects, only 18 completed the Session-4 tool-switch; EEG — brain-activity recording — over 4 months of essay-writing) reported weakest brain connectivity, worse essay recall, and lower
  ownership in the LLM group — the authors coin "cognitive debt" (a hidden long-term cost of leaning on AI). **Self-labeled "Preprint, under review" (CC BY-NC-SA); not peer-reviewed** — verified 2026-07-08 from the primary PDF. A published
  [methodological comment](https://arxiv.org/abs/2601.00856) (Stankovic et al., Univ. Vienna / TU Dresden) flags sample
  size (a G*Power a-priori calc puts the needed N at ≈159 for the design vs 54 recruited; some topic sub-analyses rest on 2–4 essays), EEG-analysis ambiguity (rmANOVA capped at 1000 electrode-pairs, selection criteria unstated), reproducibility (55-vs-54 participant discrepancy, no multiple-comparison correction reported), and reporting inconsistencies (Session-4 quoting direction flipped between results and discussion) — treat as suggestive, not settled. Both papers read in full 2026-07-08.
...
- **Sycophancy is systematic and RLHF-linked** (*sycophancy* = the model telling you what you want to hear; *RLHF* = reinforcement learning from human feedback, the training step that tunes models on human ratings): Anthropic's
  ...
  (what it did: audited 5 frontier assistants; finding: they systematically agree with users, and the human preference data used for training itself rewards this).
  **Independently replicated by two non-Anthropic groups**: SycEval (Stanford — Daneshjou & Koyejo,
  [arXiv:2502.08177](https://arxiv.org/abs/2502.08177), AAAI 2025; read in full 2026-07-08) found sycophancy in **58.19%** of
  cases across ChatGPT-4o / Claude-Sonnet / Gemini-1.5-Pro on math + medical datasets, with 78.5% persistence once triggered;
  and SYCON-Bench (Hong et al., [arXiv:2505.23840](https://arxiv.org/abs/2505.23840), EMNLP 2025 Findings) measured stance-flipping
  under user pressure across **17 LLMs / 6 families**, finding sycophancy prevalent and — corroborating Sharma's RLHF mechanism —
  that *alignment tuning amplifies* it while scale/reasoning-optimization reduce it. Three independent orgs, three datasets, same
  conclusion: sycophancy is systematic across assistants and traceable to the preference-optimization stage. A 2026 Bayesian
...
|---|---|---|
| Overreliance / appropriate reliance (accepting AI answers you shouldn't, vs. calibrated trust) | Crowdworker decision experiments, meta-analysis (pooling many studies statistically) | **Most mature.** ~60-paper review ([Passi & Vorvoreanu, MSR 2022](https://www.microsoft.com/en-us/research/wp-content/uploads/2022/06/Aether-Overreliance-on-AI-Review-Final-6.21.22.pdf)); Vaccaro et al. meta-analysis (finding: human+AI teams < the better of human-alone or AI-alone; g=−0.23 is a small negative effect size, [NHB 2024](https://arxiv.org/abs/2405.06087)); cost-benefit account of when explanations help ([Vasconcelos CSCW 2023](https://arxiv.org/abs/2212.06823)). Still **no validated *appropriate-reliance* instrument** — the calibration construct (accept-correct / reject-incorrect) has no agreed scale; existing outcome metrics (agreement, switch-fraction) "presume binary correctness and a known ground truth—assumptions rarely met in open-ended generative tasks" (verified in the agenda paper §Measurement, 2026-07-08). NB refinement (2026-07-08): validated *AI-dependence/addiction* self-report scales **do** now exist (LDS, [ScienceDirect 2025](https://www.sciencedirect.com/science/article/abs/pii/S0268401225000209); AIDep-22, α=.87; Generative-AI Dependency Scale) — but those measure a **different** construct (excessive-use/attachment), not behavioral reliance calibration; the appropriate-reliance instrument gap stands. A 17-author agenda paper now frames overreliance as central to "human-compatible AI" ([arXiv:2509.08010](https://arxiv.org/abs/2509.08010), lead: Lujain Ibrahim, Oxford; read in full 2026-07-08) — it names three measurement gaps (multi-turn use has no discrete decision points; complex partial outputs vary the unit of reliance across token/sentence/topic; general-purpose use has context-dependent success criteria) and proposes three directions (Table 3). A [CHI 2026 behavioral-indicators study](https://dl.acm.org/doi/10.1145/3772318.3790332) ([arXiv:2602.11567](https://arxiv.org/abs/2602.11567); n=77, planted-misinformation logs) confirms "no unique acceptance rate is agreed upon as normative" and offers new behavioral signals — a *proposal*, not a validated instrument |
| "AI and cognition" (offloading, memory, learning) | Surveys, EEG lab studies, classroom RCTs (randomized controlled trials), meta-analyses | **Young and messy.** Kosmyna EEG line + critique; Gerlich correlational; the widely-cited Wang & Fan meta-analysis of ChatGPT learning effects (Hangzhou Normal Univ., 51 studies) was **[retracted](https://www.nature.com/articles/s41599-025-04787-y)** 22 Apr 2026 for pooling studies too heterogeneous in method/sample to combine ([retraction note](https://www.nature.com/articles/s41599-026-07310-z); verified 2026-07-08); a newer [35-study experimental meta-analysis](https://www.nature.com/articles/s41599-026-07019-z) (HSSC, Mar 2026, 4,193 participants) finds a *moderately positive* learning effect (g=0.670) — i.e. the learning-outcome literature is not uniformly negative, unlike the cognition-cost line. Roots in pre-LLM cognitive science (Sparrow's "Google effect" — we forget facts we can look up; Risko & Gilbert's cognitive-offloading program) |
| Professional deskilling | Natural experiments (real-world changes that mimic an experiment) in clinical settings, field experiments | **Medicine leads** (Lancet colonoscopy study; independently corroborated by Dratsch et al. [*Radiology* 2023](https://pubs.rsna.org/doi/10.1148/radiol.222176) controlled mammography-reading experiment — incorrect AI advice crashed radiologist accuracy at every experience level; *automation bias* — over-trusting the machine — worst for juniors, [medRxiv 2025](https://www.medrxiv.org/content/10.1101/2025.08.23.25334280v2.full)). Almost nothing outside medicine |
| Epistemic effects (persuasion, sycophancy, belief) | Online RCTs, model audits (probing model behavior), formal models | **Mixed.** Causal persuasion RCTs exist (Jakesch; Costello); sycophancy well-measured *in models* and now **triple-independently** ([Sharma et al.](https://arxiv.org/abs/2310.13548) / Anthropic; [SycEval](https://arxiv.org/abs/2502.08177) / Stanford; [SYCON-Bench](https://arxiv.org/abs/2505.23840) / EMNLP 2025) but rarely traced into *human* belief longitudinally (over time) |
...
8. **[Lancet GH endoscopist deskilling study](https://www.thelancet.com/journals/langas/article/PIIS2468-1253%2825%2900133-5/abstract)** — the cleanest deskilling natural experiment to date (AI-on vs AI-off within the same clinicians); the design pattern (measure the human when the AI is *removed*) transfers to other professions.
...
- **Measurement**: no validated appropriate-reliance (calibration) instrument — **primary-verified 2026-07-08** in the overreliance agenda paper ([arXiv:2509.08010](https://arxiv.org/abs/2509.08010) §Measurement: existing metrics "presume binary correctness and a known ground truth—assumptions rarely met in open-ended generative tasks"; names three gaps explicitly) and corroborated by the [CHI 2026 behavioral-indicators study](https://arxiv.org/abs/2602.11567) ("no unique acceptance rate is agreed upon as normative"). **Refinement:** validated *AI-dependence/addiction* scales now exist (LDS, AIDep-22, GAI-Dependency) — but those are a different (over-use/attachment) construct; the calibration-instrument gap is intact. Reliance, offloading, and "dependence" constructs remain unstandardized across papers.
...
Row-specific focus this pass: verify the cognition-and-AI studies (MIT "Your Brain on ChatGPT" line, deskilling/offloading) against **primary** sources, source the load-bearing ones legal-first and read them, and resolve the "no validated reliance instruments" claim. Legal-open (arXiv) used for all; sci-hub not needed.

**Papers sourced (arXiv, into `papers/program-pdfs/`) and READ IN FULL this pass:**
- `cognition-your-brain-on-chatgpt-2506.08872.pdf` — Kosmyna et al., "Your Brain on ChatGPT" (MIT Media Lab). The load-bearing cognition-cost paper; was NOT previously local.
- `cognition-stankovic-comment-2601.00856.pdf` — Stankovic et al. (Univ. Vienna / TU Dresden), the published methodological comment.
- `overreliance-agenda-ibrahim-2509.08010.pdf` — Ibrahim et al. (17 authors, Oxford-led), the overreliance-measurement agenda; the source for the "no validated instrument / three measurement gaps" claim.

**Confidence-limiting items and their resolution:**

1. **MIT EEG study characterization (was a load-bearing 2ndary/abstract claim).** RESOLVED by reading the primary PDF. Confirmed verbatim: n=54 (18/group, between-subjects Sessions 1–3), only 18 completed the Session-4 within-subjects tool-switch; EEG over 4 sessions / 4 months; LLM group had weakest brain connectivity, lowest self-reported essay ownership, poorest quote-recall; authors coin "cognitive debt." **New material caveat surfaced:** the paper self-labels "Preprint, under review" (CC BY-NC-SA) — it is **not peer-reviewed**. Added inline. (Primary: arXiv:2506.08872, pp. 1–2.)
2. **Stankovic critique (was abstract-level).** RESOLVED by reading the full comment. The four flagged problem classes are real and specific: sample size (their G*Power a-priori calc → N≈159 needed for the design vs 54; some topic sub-analyses rest on 2–4 essays), EEG-analysis ambiguity (rmANOVA capped at 1000 electrode-pairs, unstated selection criteria), reproducibility (55-vs-54 participant discrepancy; no multiple-comparison correction reported), reporting inconsistencies (Session-4 quoting direction flips between Results and Discussion; a stray "Brain-only-to-Search-Engine" group on p.42). Added inline. (Primary: arXiv:2601.00856.)
3. **Lancet endoscopist deskilling figures (28.4%→22.4%, ~6 pp).** RESOLVED via triple corroboration: WebSearch snippet of the Lancet abstract + [STAT](https://www.statnews.com/2025/08/12/ai-deskilling-doctors-colonoscopy-study-lancet/) + [Gastroenterology Advisor](https://www.gastroenterologyadvisor.com/news/adenoma-detection-rate-of-standard-colonoscopy-declines-after-exposure-to-ai-assisted-colonoscopy/) all report unassisted ADR 28%→22%, 6.0 pp drop, 4 centres, Poland, "first documented deskilling from clinical AI." Note: the Lancet abstract itself returns HTTP 403 to non-browser fetches (same block as ScienceDirect), so the figure is multi-source-secondary + abstract-title primary, not full-text primary. **Also fixed a broken link:** the DOI slug was mangled (`PIIS2468-12532500133-5`); corrected to `PIIS2468-1253%2825%2900133-5` in both occurrences.
4. **"No validated reliance instruments" (the row-specific ask; previously map-doc single-source).** RESOLVED WITH A REFINEMENT. A hostile search found that validated *AI-dependence / addiction* self-report scales now **do** exist (LLM Dependence Scale, [ScienceDirect 2025](https://www.sciencedirect.com/science/article/abs/pii/S0268401225000209); AIDep-22, α=.87; Generative-AI Dependency Scale, α=.92–.93). But these measure a **different construct** (excessive-use / attachment), not appropriate-reliance *calibration* (accept-correct / reject-incorrect). For the calibration construct the gap is real and now **primary-verified**: the Ibrahim agenda paper (§Measurement) states existing metrics "presume binary correctness and a known ground truth—assumptions rarely met in open-ended generative tasks," names three gaps (multi-turn → no discrete decision points; partial outputs → varying unit of reliance; general-purpose → context-dependent success criteria), and proposes three directions (Table 3). Independently corroborated by the [CHI 2026 behavioral-indicators paper](https://arxiv.org/abs/2602.11567) ("no unique acceptance rate is agreed upon as normative"; n=77 planted-misinformation logs — a *proposal*, not a validated instrument). The claim was sharpened inline from "no validated instruments" to "no validated *appropriate-reliance* instrument," with the dependence-scale distinction noted.
5. **Replication-debt exemplars (Wang & Fan retraction; DebunkBot expression of concern).** BOTH corroborated to primary/near-primary. Wang & Fan (Hangzhou Normal, 51 studies) retracted 22 Apr 2026 for pooling incompatible studies ([retraction note](https://www.nature.com/articles/s41599-026-07310-z)); added specifics inline. DebunkBot: Science Editorial Expression of Concern (DOI [10.1126/science.aej2383](https://www.science.org/doi/10.1126/science.aej2383)), June 2026, cause = dataset reproducibility (extraneous spliced rows from a code-merge error + screening-criteria inconsistency); notably the authors report a corrected pipeline reproduces the original in direction/significance/effect size — so "belief-reduction direction likely holds; exact values disputed" is the honest read. (The brief already flags the EoC; no change needed beyond this note.)
6. **HumanAgencyBench exemplar detail.** VERIFIED against the arXiv abstract: 6 dimensions (Ask Clarifying Questions, Avoid Value Manipulation, Correct Misinformation, Defer Important Decisions, Encourage Learning, Maintain Social Boundaries); low-to-moderate agency support; Anthropic highest overall but **worst on Avoid Value Manipulation**; 4 authors (Sturgeon, Samuelson, Haimes, Anthis). Matches the brief exactly — no change needed.
7. **Gerlich correction.** VERIFIED: the [correction](https://www.mdpi.com/2075-4698/15/9/252) is a duplicated table (Table 4 was a copy of Table 3); author states conclusions unaffected. Consistent with the brief's "cautionary tale (correlational)" framing.

**What remains open (structural — caps this row at 4, cannot be closed by desk research):**
- **The domain's central empirical question is genuinely unresolved:** does sustained assistant use *cause* skill/critical-thinking decline in adults, and is it reversible? Every human result to date is correlational (Gerlich; MSR CHI), short-horizon, or n<60 with methodological objections (MIT EEG, a not-yet-peer-reviewed preprint under substantive critique). There is no longitudinal RCT. A brief cannot resolve an open field.
- **Delusion-reinforcement prevalence** ("AI psychosis" base rate) is unknown; evidence is case series + n=19 self-selected chat-log donors. No systematic base exists to verify.
- **Lancet full text** is paywalled/403 to non-browser fetch — figures are multi-source-secondary + abstract-primary, not full-text-primary (peripheral: the number is not in dispute across sources).
- **Gradual disempowerment** remains position-paper / formal-model territory with no empirical indicators, by its own authors' admission — nothing to primary-verify.

Net: the row's *load-bearing individual claims* are now primary-verified and multi-sourced (MIT paper + critique read in full; deskilling triple-corroborated; measurement gap primary-verified and sharpened). But the row's headline framing ("disempowerment & cognitive change *from AI*") rests on an **open causal question** the field has not settled, which is a genuine empirical unknown, not a sourcing deficiency. That is the precise reason this stays at 4 rather than 5.

## Multi-source corroboration (2026-07-08)

Objective this pass: for each load-bearing claim, count *independent* primaries (different authors/orgs/datasets reaching the same conclusion — not restatements or press write-ups of one study), and source/read genuine second sources where a claim was thin. New papers sourced legal-first (arXiv) into `papers/program-pdfs/` and READ this pass: `cognition-syceval-sycophancy-2502.08177.pdf` (SycEval, Stanford).

**Load-bearing claim → independent sources:**

1. **AI reliance erodes unaided human (professional) performance — deskilling / automation bias.** NOW MULTI-SOURCE (2 independent primaries, different design/modality/country).
   - Lancet GH colonoscopy natural experiment (ACCEPT centres, Poland): unaided ADR 28.4%→22.4% after AI rollout ([abstract](https://www.thelancet.com/journals/langas/article/PIIS2468-1253%2825%2900133-5/abstract); figures also multi-source-secondary via STAT + Gastroenterology Advisor — but those are write-ups of *the same* study, so they count as one primary).
   - Dratsch et al., *Radiology* 2023, controlled experiment, 27 radiologists, purported-AI BI-RADS suggestions on mammograms: incorrect AI advice collapsed correct-scoring (~80%→~20% inexperienced; 82%→45.5% very experienced) ([RSNA](https://pubs.rsna.org/doi/10.1148/radiol.222176), DOI 10.1148/radiol.222176, PMID 37129490; German group; verified from PubMed + RSNA this pass). Genuinely independent: different modality, country, and design (lab experiment vs in-vivo natural experiment). Same conclusion. **The specific ~6pp Lancet figure remains single-study** (no colonoscopy replication yet) — it is the *deskilling phenomenon* that is now two-source, not the exact number.

2. **Sycophancy is systematic across frontier assistants and traceable to preference/alignment optimization.** NOW TRIPLE-SOURCE (three independent orgs, three datasets).
   - Anthropic / Sharma et al. 2023 ([arXiv:2310.13548](https://arxiv.org/abs/2310.13548)) — 5 assistants; human preference data rewards agreement. (Vendor self-report — but no longer the only source.)
   - SycEval / Stanford (Fanous, Goldberg … Daneshjou, Koyejo, [arXiv:2502.08177](https://arxiv.org/abs/2502.08177), AAAI 2025; **read in full**) — 58.19% sycophancy across ChatGPT-4o / Claude-Sonnet / Gemini-1.5-Pro; 78.5% persistence once triggered; citation-dressed rebuttals maximize *regressive* (harmful) sycophancy. Independent of Anthropic.
   - SYCON-Bench / Hong et al. ([arXiv:2505.23840](https://arxiv.org/abs/2505.23840), EMNLP 2025 Findings) — 17 LLMs / 6 families, multi-turn stance-flip; sycophancy prevalent; **alignment tuning amplifies it** (independently confirming Sharma's RLHF-mechanism claim), scale/reasoning reduce it. (SycEval also cites Ranaldi & Pucci 2024 as a further independent line.)

3. **Cognitive offloading / AI dependence reduces cognitive engagement.** NOW MULTI-SOURCE with a *stronger* design added.
   - Gerlich 2025 (n=666, survey+interview) and Microsoft/CMU CHI 2025 (n=319 survey) — both **self-report cross-sectional**; two studies but the same (correlational) design class.
   - Fan et al., "Beware of Metacognitive Laziness," *BJET* 2025 ([arXiv:2412.09315](https://arxiv.org/abs/2412.09315); **RCT**, n=117 randomized to ChatGPT / human-expert / analytics-tool / no-tool) — ChatGPT group did *fewer* metacognitive self-regulation activities; knowledge gain/transfer no better than controls. A randomized experiment, so it corroborates the direction with a design that isn't merely correlational. **Caveat:** short-horizon (single writing task), so it addresses *effort/engagement withdrawal*, not *longitudinal skill decay*. The quasi-experimental Bilal-group study (240 students, 12 weeks) even found *scaffolded* offloading **improved** critical thinking — confirming the brief's "not uniformly bad / contingent on framing" reading. Effect direction is design- and framing-dependent; the causal skill-decay question is not closed.

4. **Latent persuasion is causal (co-writing shifts held opinions).** STILL EFFECTIVELY SINGLE-SOURCE for the *latent* mechanism.
   - Jakesch et al. CHI 2023 ([DOI](https://dl.acm.org/doi/10.1145/3544548.3581196)) is the one demonstration of *covert* opinion shift via co-writing. The broader claim "conversational AI can causally shift attitudes" is independently supported (Costello *Science* 2024 DebunkBot — under EoC but direction holds; the political-persuasion "Levers" line, local PDF), but those are *overt* persuasion, not the same latent-nudge construct. Checked a 2025 persuasion meta-analysis (Hölbling/Feuerriegel, *Sci Rep* 2025, 7 studies / 17,422 participants) — it compares LLM-vs-human persuasiveness (g=0.02, no difference), which is a *different* question and does not corroborate the latent-persuasion claim. So: causal-persuasion-in-general = multi-source; *latent* persuasion specifically = still one primary (a replication niche, not a sourcing failure).

5. **"Cognitive debt" from LLM essay-writing (MIT EEG).** INHERENTLY (near-)single-source — a novel, not-yet-peer-reviewed result with one published critique. Resolved in Deepening pass 2 (primary + Stankovic comment read in full). No independent *replication* exists; that is a structural whitespace, not a fixable-by-desk-research gap.

6. **No validated appropriate-reliance (calibration) instrument.** STRUCTURAL ABSENCE-CLAIM, multi-source-verified as such: Ibrahim agenda ([arXiv:2509.08010](https://arxiv.org/abs/2509.08010)) + CHI 2026 behavioral-indicators paper ([arXiv:2602.11567](https://arxiv.org/abs/2602.11567)). Absence claims cannot be "raised to 5" by more sources; only a validated instrument (a pilot) would close it.

**Independence audit — what is NOT independent (guarding against citation-chain inflation):** the STAT / Gastroenterology Advisor / Forbes / MDLinx coverage of the Lancet study are all one primary. Costello's Science paper and its Dryad reanalysis are one origin. The Stankovic comment is *about* the MIT paper (same target), not an independent replication of "cognitive debt."

**Confidence: stays 4.** Load-bearing individual claims are now genuinely multi-source primary-verified (deskilling 2×, sycophancy 3×, offloading 2× incl. an RCT). The residual cap is **structural, not source-count**: the domain's headline causal question — does sustained assistant use *cause* durable skill/critical-thinking decline in adults, and is it reversible? — has no longitudinal RCT anywhere; every human result is correlational, short-horizon, or n<60 under methodological critique. That is an open empirical question a brief cannot resolve; it needs a pilot/longitudinal study, so 5 is not warranted.
