...
**1. Skill & cognition (individual).**
- **Professional deskilling is now empirically documented in medicine**: endoscopists' adenoma
  detection rate in *non*-AI colonoscopies dropped ~6 percentage points (28.4%→22.4%) after
  ...
  (ACCEPT-trial centres, Poland), with an accompanying
...
- **Effort withdrawal under good AI**: Dell'Acqua's "falling asleep at the wheel" recruiter
  experiments (higher-quality AI → less human effort, worse human judgment) and the
  ...
  field experiment (758 consultants; quality collapses when the task is outside AI's frontier
...
- **Cognitive offloading correlates**: Gerlich's survey+interview study (n=666) found frequent
  ...
  cross-sectional** — causality open (map doc's central caveat).
- **Neural/behavioral traces**: MIT Media Lab's "[Your Brain on ChatGPT](https://arxiv.org/abs/2506.08872)"
  (n=54, EEG over 4 months) reported weakest brain connectivity, worse essay recall, and lower
  ownership in the LLM group — the authors coin "cognitive debt." A published
...
**2. Beliefs & epistemics.**
- **Latent persuasion is causal and demonstrated**: co-writing with an opinionated LLM shifted
  what people wrote *and subsequently believed* — Jakesch et al.,
  [CHI 2023 honorable mention](https://dl.acm.org/doi/10.1145/3544548.3581196) ([Cornell summary](https://news.cornell.edu/stories/2023/05/writing-ai-help-can-shift-your-opinions)).
- **Sycophancy is systematic and RLHF-linked**: Anthropic's
  [Towards Understanding Sycophancy in Language Models](https://arxiv.org/abs/2310.13548)
  (5 frontier assistants; human preference data itself rewards sycophancy). A 2026 Bayesian
  model shows sycophancy rates as low as π=0.1 produce "catastrophic delusional spiraling" even
...
- **Delusion reinforcement / "AI psychosis"**: media-reported case series (Morrin et al. 2025,
  17 cases) and a mechanisms review in
...
- **The direction isn't uniformly bad**: personalized GPT-4 dialogues durably reduced conspiracy
  ...
  [Science 2024](https://www.science.org/doi/10.1126/science.adq1814)) — though Science issued an
  ...
  over dataset reproducibility in June 2026; and follow-up work finds such dialogues reduce
  specific false beliefs **without building lasting discernment skills**
  ([arXiv:2510.01537](https://arxiv.org/html/2510.01537v1) ⚠️ read from abstract).

**3. Agency & societal control.**
- **Gradual disempowerment**: incremental AI substitution for human labor/cognition weakens both
  ...
  ([arXiv:2501.16946](https://arxiv.org/abs/2501.16946); ICML 2025 position paper; now an
...
- **Agency preservation as an alignment target**: Mitelut, Smith & Vamplew argue intent-aligned
  AI *depletes* human agency and propose "agency foundations" research
  ([arXiv:2305.19223](https://arxiv.org/abs/2305.19223) → [ICML 2024 position](https://proceedings.mlr.press/v235/mitelut24a.html)).
- **Oversight collapse**: real-time human oversight of fast agents may be structurally impossible
...
|---|---|---|
| Overreliance / appropriate reliance | Crowdworker decision experiments, meta-analysis | **Most mature.** ~60-paper review ([Passi & Vorvoreanu, MSR 2022](https://www.microsoft.com/en-us/research/wp-content/uploads/2022/06/Aether-Overreliance-on-AI-Review-Final-6.21.22.pdf)); Vaccaro et al. meta-analysis (teams < best-of-either, g=−0.23, [NHB 2024](https://arxiv.org/abs/2405.06087)); cost-benefit account of when explanations help ([Vasconcelos CSCW 2023](https://arxiv.org/abs/2212.06823)). Still **no validated instruments** (map doc). A 17-author agenda paper now frames overreliance as central to "human-compatible AI" ([arXiv:2509.08010](https://arxiv.org/abs/2509.08010), lead: Lujain Ibrahim, Oxford) |
| "AI and cognition" (offloading, memory, learning) | Surveys, EEG lab studies, classroom RCTs, meta-analyses | **Young and messy.** Kosmyna EEG line + critique; Gerlich correlational; the widely-cited Wang & Fan meta-analysis of ChatGPT learning effects was **[retracted](https://www.nature.com/articles/s41599-025-04787-y)**; a newer [35-study experimental meta-analysis](https://www.nature.com/articles/s41599-026-07019-z) exists. Roots in pre-LLM cognitive science (Sparrow's "Google effect," Risko & Gilbert's cognitive-offloading program) |
| Professional deskilling | Natural experiments in clinical settings, field experiments | **Medicine leads** (Lancet colonoscopy study; automation bias worst for juniors — [medRxiv 2025](https://www.medrxiv.org/content/10.1101/2025.08.23.25334280v2.full)). Almost nothing outside medicine |
| Epistemic effects (persuasion, sycophancy, belief) | Online RCTs, model audits, formal models | **Mixed.** Causal persuasion RCTs exist (Jakesch; Costello); sycophancy well-measured *in models* ([Sharma et al.](https://arxiv.org/abs/2310.13548)) but rarely traced into *human* belief longitudinally |
| Delusion reinforcement / companion harms | Case series, chat-log donation studies, one RCT | **Pre-paradigmatic.** MIT+OpenAI 4-week RCT (n=981): manipulated variables null, harms observational (map doc, [arXiv:2503.17473](https://arxiv.org/abs/2503.17473)); first chat-log study of delusional spirals ([arXiv:2603.16567](https://arxiv.org/abs/2603.16567), 19 users, 391k messages) |
| Gradual disempowerment / agency | Position papers, formal models, benchmarks, workshops | **Theory-heavy, empirics starting.** [HumanAgencyBench](https://arxiv.org/abs/2509.08494) (6 agency dimensions; low-to-moderate support across LLMs); [Post-AGI workshops](https://post-agi.org/) (Vancouver Jul 2025, NeurIPS Dec 2025) |
...
5. **[HumanAgencyBench (arXiv:2509.08494)](https://arxiv.org/abs/2509.08494)** — 4 authors, largely API-driven; operationalizes "supports human agency" into 6 measurable dimensions; found low-to-moderate agency support (Anthropic models highest overall yet worst on value manipulation). Proof that benchmark-building is a viable solo/small-team entry.
...
- **Dose–response**: the MIT/OpenAI companion RCT manipulated modality/topic — not *duration*; heavy-use harm remains observational ([arXiv:2503.17473](https://arxiv.org/abs/2503.17473)).
